    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">Detail Pegawai</h4>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4 col-xs-12">
                                <center>
                                    <img id="fotoPegawai" src="" alt="" class="img-thumbnail img-responsive" width="250">
                                </center>
                                <br>
                            </div>
                            <div class="col-md-8 col-xs-12">
                                ...
                                <table class="table">
                                    <tr>
                                        <td><strong><i class="fa fa-user"></i> Username </strong></td>
                                        <td> : </td>
                                        <td id="dusername"></td>
                                    </tr>
                                    <tr>
