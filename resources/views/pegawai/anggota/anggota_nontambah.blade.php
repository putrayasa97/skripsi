      ...
      <form id="formAnggota" class="form-horizontal form-label-left" action="{{ route('anggota.noninsert') }}" data-parsley-validate method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_paketdtl">Tarif Perdatang <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12 input-group">
                <input id="id_paketdtl" type="hidden" name="id_paketdtl"  value="{{$paketdtl[0]->id_paketdtl}}" >
                <div class="form-control">{{$paketdtl[0]->harga}}</div>
                </div>
             </div>
