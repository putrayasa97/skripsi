    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Ubah Service</h4>
            </div>
            <div class="modal-body">

            <!--FORM-->
            <form id="formServiceUbah" class="form-horizontal form-label-left" action="{{ route('service.insert') }}" data-parsley-validate method="post" >
                {{ csrf_field() }}
